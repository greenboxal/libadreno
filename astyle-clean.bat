...
set progdir=.
%progdir%\AStyle.exe --indent=tab --style=ansi --indent-cases --indent-preprocessor --indent-col1-comments --pad-oper --align-pointer=name -R "%indir%\*.c" "%indir%\*.h"
